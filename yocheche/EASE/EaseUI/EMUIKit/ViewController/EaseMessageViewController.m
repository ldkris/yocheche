...
- (UIImagePickerController *)imagePicker
{
    if (_imagePicker == nil) {
        ...
        [_imagePicker.navigationBar setBackgroundImage:[self imageWithUIView:bg] forBarMetrics:UIBarMetricsDefault];
        
        _imagePicker.navigationBar.barStyle = UIBarStyleDefault;//设置bar的风格，控制字体颜色
        _imagePicker.navigationBar.clipsToBounds = NO;
        _imagePicker.navigationBar.translucent = YES;//viewcontroller'view'y 偏移修改
        [_imagePicker.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor whiteColor],NSForegroundColorAttributeName,[UIFont systemFontOfSize:17],NSFontAttributeName,nil]];
        //yocheche end
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([object isKindOfClass:[NSString class]]) {
        ...
        //yocheche
        [timeCell setTitleLabelColor:[UIColor lightGrayColor]];
        //yocheche end
        return timeCell;
    }
    else{
