...
+ (void)initialize
{
    ...
    cell.titleLabelColor = YCC_DarkGray;
    cell.titleLabelFont = [UIFont systemFontOfSize:15];
    cell.detailLabelColor = YCC_LightGray;
    cell.detailLabelFont = [UIFont systemFontOfSize:14];
    cell.timeLabelColor = YCC_LightGray;
...
- (void)_setupSubview
{
    ...
    //yocheche
    [self.lineView0 removeFromSuperview];
    self.lineView0=nil;
    self.lineView0=[[UIView alloc] initWithFrame:CGRectMake(10, 59, 300, 1)];
