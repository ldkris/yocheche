...
#import "CommentMyListCell.h"
@interface CommentMyListVC ()

@end

@implementation CommentMyListVC
...
{
    [MobClick beginLogPageView:@"CommentMyListVC"];
}
-(void)viewWillDisappear:(BOOL)animated
{
    [MobClick endLogPageView:@"CommentMyListVC"];
}
...
-(void)updateData
{
    ...
    req.socialMethord=@"user/getMyCommentList.yo";
...
{
    CommentMyListCell *cell=[tableView dequeueReusableCellWithIdentifier:@"CommentMyListCell"];
    if (cell==nil)
    {
        cell=[[[NSBundle mainBundle] loadNibNamed:@"CommentMyListCell" owner:nil options:nil] objectAtIndex:0];
    }
