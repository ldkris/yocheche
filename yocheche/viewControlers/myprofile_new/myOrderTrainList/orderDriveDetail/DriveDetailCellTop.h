...
@class DriveDetailCellTop;
@protocol DriveDetailCellTopDelegate <NSObject>
-(void)showCoachDetailVC:(NSString*)coachID;
@end

@interface DriveDetailCellTop : UITableViewCell
@property(nonatomic,assign)id<DriveDetailCellTopDelegate> delegate;
